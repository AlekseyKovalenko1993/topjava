...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealTo> getFilteredWithExcessByCycle(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        final Map<LocalDate, Integer> caloriesSumByDate = getMapCaloriesByDate(meals);
    ...
    public static Map<Integer,MealTo> getWithExcess(Map<Integer,Meal> meals, int caloriesPerDay) {
        final Map<LocalDate, Integer> caloriesSumByDate = getMapCaloriesByDate(new ArrayList<>(meals.values()));
        final Map<Integer,MealTo> mealsWithExcess = new ConcurrentHashMap<>();
        meals.forEach((k,v) -> {
            mealsWithExcess.put(k,createWithExcess(v,caloriesSumByDate.get(v.getDate()) > caloriesPerDay));
        });
        return mealsWithExcess;
    }

    public static Map<LocalDate, Integer> getMapCaloriesByDate(List<Meal> meals) {
