...
<div class="jumbotron pt-4">
    ...
    <form id="filter">
        ...
        <div>
            ...
            <button type="button" class="btn btn-primary" id="filterReset"><spring:message code="meal.reset"/></button>
        </div>
    </form>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" id="dateTime" name="dateTimeStr"
                    ...
                    <div class="form-group">
                        <label for="meal.calories" class="col-form-label"><spring:message code="meal.calories"/></label>
                        <input type="text" class="form-control" id="meal.calories" name="calories"
